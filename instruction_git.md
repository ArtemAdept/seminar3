...
Для того, чтобы объединить ветки, нужно ввести команду:

    git merge / <branche_name>

Где <branch_name> - имя вливаемой ветки.

 При некорректном объединении веток, может возникнуть конфликт. (пример создания, слияния, конфликта)
